...
public class ResTest {
  ...
  /**
   * 
   * Test for the SimpleGETtesttest_ID711739 method.
   * 
   */
  @Test
  public void testSimpleGETtesttest_ID711739() {
...
""", "text/plain", "*/*", new HashMap<>(), new Object[0]);
      System.out.println("Result of request with id: 923605: " + result.getResponse().trim());
    
      Assert.assertEquals("[717504]", 200, result.getHttpCode());
